    ...
    <div className="app-overlay z-[500] transition-opacity" onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="app-bottom-sheet">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
          ...
          <div>
            <label className="block text-xs font-semibold tracking-[0.5px] uppercase text-text2 mb-[7px]">Alasan</label>
        ...
        <div className="mb-2">
          <label className="block text-xs font-semibold tracking-[0.5px] uppercase text-text2 mb-[7px]">Penyesuaian Jadwal ({schedules.length} Kelas)</label>
                  ...
                  <div key={s.id} className="bg-surface border border-border2 rounded-2xl p-4 shadow-sm transition-all">
                    <div className="flex justify-between items-start mb-2">
                      <div className="min-w-0 pr-2">
                        ...
                        {s.nextMat && (
                          <div className="text-xs text-text3 mt-0.5 truncate">Materi Reguler: {s.nextMat.name}</div>
                        )}
                      </div>
